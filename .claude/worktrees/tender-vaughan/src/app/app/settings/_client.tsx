...
import { Clock, Loader2, Link2, Trash2, Copy, Check, Plus, X, ArrowLeft } from 'lucide-react'
      ...
      <div className="max-w-2xl mx-auto">
        ...
        {activeTab === 'organization' && (
          <div className="space-y-4">
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-5">
              <h2 className="text-sm font-semibold text-slate-300 mb-1">Organization name</h2>
        ...
        {activeTab === 'danger' && (
          <div className="bg-red-950/20 border border-red-900/40 rounded-xl p-5">
            ...
            <p className="text-slate-500 text-sm">Destructive actions will appear here.</p>
          </div>
        )}
      </div>
    </div>
