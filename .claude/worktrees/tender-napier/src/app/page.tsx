...
const FEATURES = [
  ...
  },
  {
    ...
    description: "Checkout overlay, customer portal, trial enforcement, and webhook handling. Everything you need to start charging.",
    items: ["Paddle Billing checkout", "Trial + subscription gate", "Billing portal & webhook handler"],
  },
  {
      ...
      <section id="pricing" className="bg-white py-20 sm:py-28">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 text-lg">Set your own price. This is the starter — configure Paddle with your price ID.</p>
          </div>
          <div className="max-w-sm mx-auto">
            <div className="bg-white rounded-2xl border-2 border-blue-600 shadow-xl p-10 text-center">
              ...
              <p className="text-sm text-gray-400 mb-8">Your pricing here. Configure in Paddle.</p>
