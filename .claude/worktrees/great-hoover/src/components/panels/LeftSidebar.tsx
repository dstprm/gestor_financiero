...
export function LeftSidebar({ open, onClose, isViewer }: LeftSidebarProps) {
  ...
  return (
    ...
    >
      ...
      {/* Add Person button — pinned with absolute so it's always visible */}
      {!isViewer && (
        <div className="absolute bottom-0 left-0 right-0 bg-gray-50 dark:bg-slate-900 border-t border-gray-200 dark:border-slate-700 p-3">
          <button
