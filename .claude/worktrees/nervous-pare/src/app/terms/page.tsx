      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-10 leading-relaxed">
          ...
          <section>
            ...
            <p>
              ClaudeKit is a cloud-based software-as-a-service (SaaS) platform. The Service includes web interfaces, collaboration features, and data management capabilities. We reserve the right to modify, suspend, or discontinue any aspect of the Service at any time with reasonable notice.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:[YOUR_SUPPORT_EMAIL]" className="text-blue-400 hover:underline">[YOUR_SUPPORT_EMAIL]</a>{" "}
          ...
          <section>
            ...
            <p>
              <strong className="text-gray-200">Free Trial.</strong> New accounts receive a 14-day free trial with full access to all features. No credit card is required to start a trial. At the end of the trial period, your account will enter a restricted state unless you activate a paid subscription.
            </p>
            <p className="mt-3">
              <strong className="text-gray-200">Pricing.</strong> Current pricing is listed on our website and within the Service. Prices are subject to change with 30 days&apos; written notice.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p>
              ...
              <Link href="/privacy" className="text-blue-400 hover:underline">Privacy Policy</Link>, which is incorporated into these Terms by reference. You retain full ownership of all data you upload to the Service ("Customer Data"). You grant ClaudeKit a limited, non-exclusive license to process Customer Data solely to provide the Service. We will not sell your Customer Data to third parties.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              These Terms are governed by and construed in accordance with the laws of [YOUR JURISDICTION], without regard to conflict of law principles. Any disputes arising under these Terms shall be subject to the jurisdiction of the courts of [YOUR JURISDICTION]. If you are a consumer in the EU or UK, you may also have rights under your local mandatory consumer protection laws that cannot be waived by contract.
            </p>
          </section>
          ...
          <section>
            ...
            <address className="not-italic mt-2 space-y-1 text-gray-400">
              ...
              <p>Email: <a href="mailto:[YOUR_SUPPORT_EMAIL]" className="text-blue-400 hover:underline">[YOUR_SUPPORT_EMAIL]</a></p>
            </address>
          </section>
