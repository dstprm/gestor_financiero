      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-10 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3"><strong className="text-gray-200">Customer Data:</strong> We store the data you create and upload within the Service, including any content, configurations, and settings you enter into the platform.</p>
          ...
          <section>
            ...
            <p className="mt-3">We do not use your data for advertising and we do not sell your data to third parties.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-400">
              ...
              <li>
                <strong className="text-gray-200">Supabase</strong> — Database and backend storage hosted in the US. Your data is stored in Supabase-managed databases. See{" "}
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-400">
              ...
              <li><strong className="text-gray-200">Erasure ("Right to be Forgotten"):</strong> Request deletion of your personal data. You can delete your data and account at any time from within the Service.</li>
            ...
            <p className="mt-3">
              ...
              <a href="mailto:[YOUR_SUPPORT_EMAIL]" className="text-blue-400 hover:underline">[YOUR_SUPPORT_EMAIL]</a>. We will respond within 30 days. You also have the right to lodge a complaint with your local data protection authority.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              This Privacy Policy is governed by the laws of [YOUR JURISDICTION]. Any disputes arising under this policy shall be subject to the jurisdiction of the courts of [YOUR JURISDICTION], without prejudice to any mandatory consumer rights you may have under your local laws.
            </p>
          </section>
