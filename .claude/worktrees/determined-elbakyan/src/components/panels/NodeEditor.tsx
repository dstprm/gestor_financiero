  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-slate-900">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-slate-700">
        ...
        <button onClick={() => setSelectedNode(null)} className="text-gray-400 dark:text-slate-500 hover:text-gray-700 dark:hover:text-slate-300 shrink-0">
          <X size={16} />
        </button>
      </div>
      ...
      <div className="border-t border-gray-200 dark:border-slate-700 p-3 flex items-center gap-2">
        <button
          ...
          className="p-2 text-gray-400 dark:text-slate-500 hover:text-red-400 rounded-lg hover:bg-red-400/10 transition-colors"
