...
export function NodeEditor() {
  ...
  return (
    <div className="relative h-full bg-white dark:bg-slate-900 flex flex-col">
      ...
      {showCloseWarning && (
        <div className="shrink-0 flex items-center gap-2 px-4 py-2 bg-amber-50 dark:bg-amber-950/30 border-b border-amber-200 dark:border-amber-700 text-xs text-amber-700 dark:text-amber-300">
      ...
      <div className="flex-1 overflow-y-auto min-h-0 p-4 space-y-4 pb-16">
        {/* Flags */}
        <div>
      ...
      {/* Footer actions — pinned with absolute so it's always visible */}
      <div className="absolute bottom-0 left-0 right-0 bg-white dark:bg-slate-900 border-t border-gray-200 dark:border-slate-700 p-3 flex items-center gap-2">
        <button
