  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-300">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-10 leading-relaxed">
          ...
          <p className="text-gray-400">
            SimplyOrg ("we," "us," or "our") is committed to protecting your personal data. This Privacy Policy explains what data we collect, how we use it, and your rights under applicable privacy laws, including the EU General Data Protection Regulation (GDPR), UK GDPR, and the California Consumer Privacy Act (CCPA).
          </p>
          ...
          <section>
            ...
            <p className="mt-3"><strong className="text-gray-200">Org Chart Data:</strong> We store the organizational data you create within SimplyOrg, including employee names, titles, roles, departments, reporting relationships, and scenario plans you enter into the platform.</p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-400">
              ...
              <li>
                <strong className="text-gray-200">Paddle</strong> — Payment processing and subscription billing. Paddle is the Merchant of Record for SimplyOrg subscriptions, meaning they collect and process your payment information directly under their own terms. We do not receive or store your card details. See{" "}
          ...
          <section>
            ...
            <address className="not-italic mt-2 space-y-1 text-gray-400">
              <p><strong className="text-gray-200">SimplyOrg</strong></p>
      ...
      <footer className="border-t border-gray-800 py-6 px-6 text-center text-sm text-gray-600 mt-8">
        © 2026 SimplyOrg. All rights reserved. &nbsp;·&nbsp;
