  ...
  return (
    <>
      ...
      >
        ...
        {/* Content */}
        <div
          className="flex-1 overflow-hidden flex flex-col md:flex-1"
          style={{ height: 'calc(65vh - 80px)' }}
        >
          <div className="flex-1 overflow-auto flex flex-col md:h-auto md:flex-1" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
