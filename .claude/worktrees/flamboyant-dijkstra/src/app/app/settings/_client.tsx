                  ...
                  {isPaddleConfigured ? (
                    <>
                      <button
                        ...
                        className="w-full px-4 py-2.5 bg-gray-900 dark:bg-slate-700 hover:bg-gray-700 dark:hover:bg-slate-600 text-white text-sm font-medium rounded-xl transition-colors"
                      >
                        Manage Subscription →
                      </button>
                      <p className="text-xs text-gray-400 dark:text-slate-500 text-center mt-2">
                        Opens in Paddle&apos;s secure billing portal
                      </p>
                    </>
                  ) : (
