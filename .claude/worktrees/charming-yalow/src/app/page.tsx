      ...
      <section id="pricing" className="bg-white py-20 sm:py-28">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 text-lg">Flat-rate. No per-seat surprises.</p>
          </div>
          <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
            {/* Starter */}
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
              <div className="mb-4">
                <span className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Starter</span>
              </div>
              <div className="mb-1">
              ...
              <Link
                href="/app"
                className="block w-full border border-blue-600 text-blue-600 hover:bg-blue-50 font-semibold px-6 py-3 rounded-xl text-center transition-colors text-sm"
              >
                Start free trial
              </Link>
            </div>
            ...
            {/* Growth */}
            <div className="bg-white rounded-2xl border-2 border-blue-600 shadow-xl p-8 relative">
